...
class TestLanding(TransactionCase):
    ...
    def test_a_new_user_lands_on_the_app_grid(self):
        ...
        self.assertTrue(
            ...
            "A user with no home action must land on the app grid, which is the whole point of installing this module.",
        )
    ...
    def test_a_home_action_still_wins(self):
        ...
        self.assertFalse(
            user.is_redirect_home,
            "A home action must override the app grid, or nobody can choose their own landing screen.",
        )
