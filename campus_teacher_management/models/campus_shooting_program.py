...
class CampusShootingProgram(models.Model):
    ...
    applicant_id = fields.Many2one("hr.applicant", "Teacher", required=True, ondelete="cascade", index=True)
    session_ids = fields.One2many("campus.shooting.session", "program_id", "Shooting Sessions")
