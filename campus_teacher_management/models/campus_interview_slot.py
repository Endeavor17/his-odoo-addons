...
class CampusInterviewSlot(models.Model):
    ...
    duration = fields.Float("Duration", default=0.5, required=True, help="In hours. 0.5 is thirty minutes.")
    ...
    applicant_id = fields.Many2one(
        "hr.applicant", "Booked For", readonly=True, copy=False, ondelete="set null", index="btree_not_null"
    )
