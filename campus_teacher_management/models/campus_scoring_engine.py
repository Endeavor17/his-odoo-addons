...
class CampusScoringEngine(models.AbstractModel):
    ...
    def _collect(self, applicants):
        ...
        for version in versions:
            criteria = version.criterion_ids.filtered("active").sorted(lambda c: (c.sequence, c.code or ""))
    ...
    def _score_scale(self, criterion, value):
        ...
        _logger.info("Criterion %s: answer %r matched no scale line; scoring 0.", criterion.code, value)
        return 0.0, self._display(value)
