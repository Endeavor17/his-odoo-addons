...
class CampusEvaluationVersion(models.Model):
    ...
    criterion_ids = fields.One2many("campus.criterion", "version_id", "Criteria", copy=True)
    ...
    def _compute_counts(self):
        ...
        applicant_data = (
            ...
            .sudo()
            ._read_group([("campus_version_id", "in", self.ids)], ["campus_version_id"], ["__count"])
        )
    ...
    def write(self, vals):
        ...
        scoring_fields = {"weighting_method", "normalize", "years_cap", "criterion_ids", "version", "origin_id"}
