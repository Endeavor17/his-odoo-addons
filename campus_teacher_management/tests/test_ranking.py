...
class TestRanking(CampusCommon):
    ...
    def test_unevaluated_applications_are_not_ranked(self):
        ...
        self.assertEqual(unscored.campus_rank, 0, "an application that was never evaluated stays unranked")
    ...
    def test_archived_applications_are_excluded(self):
        ...
        self.assertEqual(keep.campus_rank, 1, "archiving the leader should promote everyone below")
