...
class CampusInterviewDirectSchedule(models.TransientModel):
    ...
    existing_slot_id = fields.Many2one("campus.interview.slot", "Current Booking", compute="_compute_existing_slot")
    ...
    interviewer_id = fields.Many2one("res.users", "Interviewer", default=lambda self: self.env.user)
