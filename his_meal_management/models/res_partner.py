...
class ResPartner(models.Model):
    ...
    meal_credits_remaining = fields.Float(
        string="Meal Credits",
        digits=(16, 2),
        compute="_compute_meal_credits_remaining",
        compute_sudo=True,
    )
    meal_card_code = fields.Char(
        string="Card Code",
        compute="_compute_meal_card_code",
        compute_sudo=True,
    ...
    meal_allowance_left = fields.Integer(
        string="Allowance Meals Left",
        compute="_compute_meal_allowance",
        compute_sudo=True,
    ...
    def _consume_meal_credit(
        self, amount=1.0, pos_order=None, tx_type="consume", note=None, product=None, allow_overdraft=False
    ):
        ...
        self.env["his.meal.subscription"].invalidate_model(["credits_used", "credits_remaining", "state"])
