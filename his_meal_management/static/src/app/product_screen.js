...
patch(ProductScreen.prototype, {
    // A meal tapped in the grid for a student is a student meal: same path as the
    // meal buttons, so credits are taken on validation. With no customer on the
    // order it is a walk-in, sold at its normal price as before.
    //
