...
class HrEmployee(models.Model):
    ...
    maintenance_hours_this_month = fields.Float(string="Hours This Month", compute="_compute_maintenance_monthly_stats")
    ...
    maintenance_workday_ids = fields.One2many(
        "maintenance.university.workday",
        "employee_id",
        string="Work Days",
    )
    maintenance_workday_state = fields.Selection(
        ...
        string="Today",
        compute="_compute_maintenance_workday_today",
    )
    ...
    def _compute_maintenance_workday_today(self):
        ...
        days = (
            self.env["maintenance.university.workday"]
            .sudo()
            .search(
                [
